import os
from bistream_mode0 import predict_quality
from bistream_mode0.utils import json_load
...
def test_model_prediction_h264():
    ...
    model_config_filename = os.path.join(root_dir, "bistream_mode0", "models", "bistream_mode0", "config.json")
